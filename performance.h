...
#define PERF_MR_ENABLED false
#define PERF_MR_SLEEP (350 * UTIME_MILLISECONDS)

// For tcmalloc, set the default release rate.
// @see https://gperftools.github.io/gperftools/tcmalloc.html
#define PERF_TCMALLOC_RELEASE_RATE 0.8
...
#define PERF_MW_SLEEP (350 * UTIME_MILLISECONDS)
/**
 ...
 */
#define PERF_MW_SO_SNDBUF

/**
 * whether set the socket recv buffer size.
 */
#undef PERF_MW_SO_RCVBUF
/**
...
#define PERF_QUEUE_COND_WAIT
    ...
    #define PERF_MW_MIN_MSGS 8
    // For RTC, use smaller wait queue.
    #define PERF_MW_MIN_MSGS_FOR_RTC 1
    // For Real-Time, never wait messages.
    #define PERF_MW_MIN_MSGS_REALTIME 0
#endif
/**
 ...
 */
#define PERF_MIN_LATENCY_ENABLED false
 ...
 */
#define PERF_CHUNK_STREAM_CACHE 16

/**
 * the gop cache and play cache queue.
 */
// whether gop cache is on.
#define PERF_GOP_CACHE true
// in srs_utime_t, the live queue length.
#define PERF_PLAY_QUEUE (30 * UTIME_SECONDS)
 ...
 * @see https://github.com/ossrs/srs/issues/320
 */
#undef PERF_TCP_NODELAY
#define PERF_TCP_NODELAY
/**
 ...
 * @remark only apply it when PERF_MW_SO_SNDBUF is defined.
 */
#ifdef PERF_MW_SO_SNDBUF
    //#define PERF_SO_SNDBUF_SIZE 1024
    #undef PERF_SO_SNDBUF_SIZE
#endif

/**
 * whether ensure glibc memory check.
 */
#define PERF_GLIBC_MEMORY_CHECK
#undef PERF_GLIBC_MEMORY_CHECK
